...
#SBATCH --ntasks=1
#SBATCH --mem=32G
#SBATCH --job-name="build_qwen_bf16"
#SBATCH -c4
...
CONFIGS=(
  ...
  "W16A16_INT8KV/build_config_W16A16_INT8KV_LOGITS.json" # 1
  "W4A16/build_config_W4A16_LOGITS.json"               # 2
  "W4A16_INT8KV/build_config_W4A16_INT8KV_LOGITS.json" # 3
  "W8A16/build_config_W8A16_LOGITS.json"               # 4
