...
The tokenizer, `prepare_dataset.py`, and output directory paths are set at the top of each generation script. Change those paths if your workspace layout is different.
